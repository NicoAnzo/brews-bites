    ...
    return (
        <div className="about-page-container">
            <section className="about-section">
                <h3 className="section-heading">Welcome to Brews & Bites!</h3>
            ...
            <section className="about-section">
                <h3 className="section-heading">Meet Our Manager</h3>
                <p className="section-paragraph">
                ...
                <img src="../../images/manager.jpg" alt="Nico's photo" className="manager-photo" />
                <p className="section-paragraph">
